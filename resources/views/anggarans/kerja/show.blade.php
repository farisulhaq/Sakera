    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <a href="{{ route('anggarans.kerja.create', $kegiatan) }}" class="btn btn-primary">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table" id="table1">
                ...
                <tbody>
                  @forelse ($kegiatan->anggarans as $anggaran)
                    <tr>
                      ...
                      <td class="text-bold-500">
                        ...
                        <form action="{{ route('anggarans.kerja.destroy', $anggaran) }}" method="post">
                          @csrf
                          @method('delete')
                        </form>
                      </td>
